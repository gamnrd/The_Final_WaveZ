...
public class PlayerResources : MonoBehaviour
{
    ...
    [SerializeField] private const int CASH_MAX = 999999;
    [SerializeField] private const int RESOURCE_MAX = 999;
    ...
    public void AddResource(ResourceType type, int amount)
    {
        switch (type)
        {
            case ResourceType.Cash:
                data.totalCash = Mathf.Min(data.totalCash + amount, CASH_MAX);
                break;
