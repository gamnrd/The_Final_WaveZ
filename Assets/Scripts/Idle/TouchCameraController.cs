...
public class TouchCameraController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        LookOffset = transform.position.y;
    ...
    public void Move(Vector3 newPosition)
    {
        ...
        moveTargetPosition.x = Mathf.Clamp(moveTargetPosition.x, xMin, xMax);
        moveTargetPosition.y = LookOffset;
        moveTargetPosition.z = Mathf.Clamp(moveTargetPosition.z, yMin, yMax);
    }
    /*
    /// <summary>
